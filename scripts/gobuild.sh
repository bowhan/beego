...
LD_EXTRAFLAGS="${LD_EXTRAFLAGS} -X github.com/bowhan/beego.GoVersion=${go_version[2]:2}"
LD_EXTRAFLAGS="${LD_EXTRAFLAGS} -X github.com/bowhan/beego.GitBranch=${CURRENT_BRANCH}"
LD_EXTRAFLAGS="${LD_EXTRAFLAGS} -X github.com/bowhan/beego.BuildTime=$BUILD_TIME"
